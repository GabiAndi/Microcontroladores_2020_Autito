...
void pwm_init(void)
{
	// Inicia las velocidades de los motores
	vel_mot_der = 0.0;
	vel_mot_izq = 0.0;
...
void pwm_set_motor_der_speed(float vel)
{
	...
	{
		__HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_1, (__HAL_TIM_GET_AUTORELOAD(&htim4) * (vel / 100.0)));
		__HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_2, 0);
	}
	...
	{
		__HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_1, 0);
		__HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_2, (__HAL_TIM_GET_AUTORELOAD(&htim4) * ((vel / 100.0) * -1.0)));
	}
}
...
void pwm_set_motor_izq_speed(float vel)
{
	...
	{
		__HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_3, (__HAL_TIM_GET_AUTORELOAD(&htim4) * (vel / 100.0)));
		__HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_4, 0);
	}
	...
	{
		__HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_3, 0);
		__HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_4, (__HAL_TIM_GET_AUTORELOAD(&htim4) * ((vel / 100.0) * -1.0)));
	}
}
